...
class Pattern extends CoreModel
{
    private $yarn;
    private $needles;
    private $gauge;
     ...
     * @return self
     */
    public static function find(string $pattern_name)
    {
        $pdo = Database::getPDO();
        $query = "SELECT * FROM `pattern` WHERE `name` = :name ;";
        $pdoStatement = $pdo->prepare($query);
        $pdoStatement->bindValue(':name', $pattern_name, PDO::PARAM_STR);
        $pdoStatement->execute();
        $pattern = $pdoStatement->fetchObject(Pattern::class);
    ...
    public function insert()
    {
        ...
        $sql = 'INSERT INTO `pattern` (name, yarn, needles, gauge, material, pattern, legStart,  legEnd, chart)
    ...
    public function delete(int $id)
    {
        ...
        $sql = 'DELETE FROM `pattern` WHERE `id` = :id';
        // Connexion to DB
        $pdo = Database::getPDO();
        // Prepare
        $pdoStatement = $pdo->prepare($sql);
    ...
    public static function findAll()
    {
        ...
        $pdoStatement = $pdo->prepare($query);
        $pdoStatement->execute();
        $patternList = $pdoStatement->fetchAll(PDO::FETCH_CLASS, Pattern::class);
