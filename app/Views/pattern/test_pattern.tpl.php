<div class="container">
    ...
    <p>Avec la méthode Judy’s Magic Cast On, monter 12 m. sur chaque aig. en coloris principal <strong>ou en coloris contrastant.</strong></p>
    <p>=> 24 m.</p>

    <h2 id="pointe">Pointe</h2>
    <p>Rang d’installation : Placer un marqueur de début de rang, tricoter 12 m. end., placer un marqueur de début de semelle, tricoter 12 m. end.</p>
