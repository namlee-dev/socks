<div class="container">
    ...
    <p>Rang d’installation : pm de début de rang, tricoter <?= $taille->getCaston() ?> m. end., pm de début de semelle, tricoter <?= $taille->getCaston() ?> m. end.</p>
    ...
    <ul>
        <li><h3>Gousset</h3></li>
        <p>R1 : tricoter <?= $taille->getGeneral() ?> m. selon le motif, gm, 1 m. end, 1augG, tricoter à l’end. jusqu’à 1 m. avant le marqueur, 1augD, 1m. end.</p>
