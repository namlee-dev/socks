<div class="container">
    ...
    <h3>Tailles</h3>
    <p>XS (S, M, L, XL) pour une circonférence de 17 (19, 21, 23, 25) cm ou pour les pointures 32/34 (35/37, 38/40, 41/43, 44/46)</p>
    ...
    <p>Rang d’installation : pm de début de rang, tricoter <?= $tailles[0]->getCaston() ?> (<?= $tailles[1]->getCaston() ?>, <?= $tailles[2]->getCaston() ?>, <?= $tailles[3]->getCaston() ?>, <?= $tailles[4]->getCaston() ?>) m. end., pm de début de semelle, tricoter <?= $tailles[0]->getCaston() ?> (<?= $tailles[1]->getCaston() ?>, <?= $tailles[2]->getCaston() ?>, <?= $tailles[3]->getCaston() ?>, <?= $tailles[4]->getCaston() ?>) m. end.</p>
    ...
    <ul>
        <li><h3>Gousset</h3></li>
        <p>R1 : tricoter <?= $tailles[0]->getGeneral() ?> (<?= $tailles[1]->getGeneral() ?>, <?= $tailles[2]->getGeneral() ?>, <?= $tailles[3]->getGeneral() ?>, <?= $tailles[4]->getGeneral() ?>) m. selon le motif, gm, 1 m. end, 1augG, tricoter à l’end. jusqu’à 1 m. avant le marqueur, 1augD, 1m. end.</p>
        ...
        <p>R3 : DM, tricoter à l’end. jusqu’à 3 m. avant la DM, 1augG, 1m. end., tourner</p>
